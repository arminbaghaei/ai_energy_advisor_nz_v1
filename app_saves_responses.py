...
def render_save_status() -> None:
    if st.session_state.get("response_saved"):
        ...
        st.markdown(
            "<div class='save-status-box'><strong>Save status:</strong> ready to submit. The completed responses will be saved to Google Sheets when you click the submit button.</div>",
            unsafe_allow_html=True,
        )
